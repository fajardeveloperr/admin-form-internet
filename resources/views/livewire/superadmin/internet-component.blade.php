                    ...
                    <div class="card-header d-flex justify-content-between" style="width:100%;">
                        ...
                        <nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row ">
                            <a class="flex-sm-fill text-sm-center nav-link active" id="orders-all-tab" data-bs-toggle="tab" 
                                href="#orders-all" role="tab" aria-controls="orders-all" aria-selected="true">Personal</a>
                            <a class="flex-sm-fill text-sm-center nav-link" id="orders-cancelled-tab" data-bs-toggle="tab"
                                href="#orders-cancelled" role="tab" aria-controls="orders-cancelled" aria-selected="false">Bussiness</a>
                        </nav>
                    </div>
                    <div class="card-body">
                                            ...
                                            <table class="table app-table-hover mb-0 text-left">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr style="text-align: center;">
                                                        <td>{{ $id }}</td>
                                                        <td>{{ $custome->id_pelanggan }}</td>
                                                        <td>{{ $custome->name }}</td>
                                                        @if ($custome->status ==NULL)
                                                        <td>-</td>
                                                        @endif
                                                        <td>
                                                            <a wire:click="detail_customer({{$custome->id }})" data-bs-toggle="modal" data-bs-target="#detail-data-modal{{ $id }}"  class="btn btn-md btn-success" href="#"><i class="fa-solid fa-eye"></i></a>
                                                            <a data-bs-toggle="modal" data-bs-target="#edit-data-modal"  class="btn btn-md btn-warning" href="#"><i class="fa-solid fa-edit"></i></a>
                                                            <a href="#" wire:click="delete_personal(`{{ $custome->id }}`)"  class="btn btn-md btn-danger"><i class="fa-solid fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <!-- Modal view -->
                                                    <div wire:ignore.self class="modal fade" id="detail-data-modal{{ $id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table mb-0 text-left">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td class="cell">{{ $id }}</td>
                                                        <td class="cell">{{ $custome->id_pelanggan }}</td>
                                                        <td class="cell">{{ $custome->name }}</td>
                                                        @if ($custome->status ==NULL)
                                                        <td class="cell">-</td>
                                                        @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            <a wire:click="delete_personal(`{{ $custome->id }}`)" class="btn btn-md btn-danger" href="#"><i class="fa-solid fa-trash"></i></a>
                                                        </td>
                                                    </tr>
